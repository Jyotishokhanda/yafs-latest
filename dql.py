...
def linear_scaling(arr):
    ...
    norm_arr = []
    for i in arr:
        norm_arr.append((i - min(arr)) / (max(arr) - min(arr)))
    return norm_arr
...
def get_state_input(state):
    ...
    for a in range(beta):
        ...
        if a < no_of_edge_devices:
            Memory.append(state['memories'][a][0])
            Memory.append(state['memories'][a][1])
        else:
            Memory.append(0)
            Memory.append(0)
    ...
    for a in range(beta):
        ...
        if a < no_of_edge_devices:
            Inst.append(state['inst'][a][0])
            Inst.append(state['inst'][a][1])
        else:
            Inst.append(0)
            Inst.append(0)
    ...
    for a in range(beta):
        ...
        if a < no_of_edge_devices:
            Bandwidth.append(state['bandwidth'][a][0])
            Bandwidth.append(state['bandwidth'][a][1])
        else:
            Bandwidth.append(-1)
            Bandwidth.append(-1)
